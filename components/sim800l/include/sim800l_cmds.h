...
//Sets phone number
static GSM_Cmd getPHONENUMBER = 
{
	.cmd = "AT+CMGS\r\n",
	.cmdSize = sizeof("AT+CMGS\r\n")-1,
	.cmdResponseOnOk = "..>",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
//Gets SIM's phone number
static GSM_Cmd confPHONENUMBER = 
{
	.cmd = "AT+CMGS=\"+5548998492367\"\r\n",
	.cmdSize = sizeof("AT+CMGS=\"+5548998492367\"\r\n")-1,
	.cmdResponseOnOk = "..>",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd confSETUP = 
{
	.cmd = "AT+CNMI=1,2,0,0,0\r\n",
	.cmdSize = sizeof("AT+CNMI=1,2,0,0,0\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd listMSG = 
{
	.cmd = "AT+CMGL=?\r\n",
	.cmdSize = sizeof("AT+CMGL=?\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd retrieveMSG1 = 
{
	.cmd = "AT+CMGR=1,0\r\n",
	.cmdSize = sizeof("AT+CMGR=1,0\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd retrieveMSG2 = 
{
	.cmd = "AT+CMGR=2,0\r\n",
	.cmdSize = sizeof("AT+CMGR=2,0\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
};
static GSM_Cmd retrieveMSG3 = 
{
	.cmd = "AT+CMGR=3,0\r\n",
	.cmdSize = sizeof("AT+CMGR=3,0\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd retrieveMSG4 = 
{
	.cmd = "AT+CMGR=4,0\r\n",
	.cmdSize = sizeof("AT+CMGR=4,0\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd retrieveMSG5 = 
{
	.cmd = "AT+CMGR=5,0\r\n",
	.cmdSize = sizeof("AT+CMGR=5,0\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd retrieveMSG6 = 
{
	.cmd = "AT+CMGR=6,0\r\n",
	.cmdSize = sizeof("AT+CMGR=6,0\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd retrieveMSG7 = 
{
	.cmd = "AT+CMGR=7,0\r\n",
	.cmdSize = sizeof("AT+CMGR=7,0\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd deleteMSG = 
{
	.cmd = "AT+CMGD=7\r\n",
	.cmdSize = sizeof("AT+CMGD=7\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd deleteMSG1 = 
{
	.cmd = "AT+CMGD=1\r\n",
	.cmdSize = sizeof("AT+CMGD=1\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd listALL = 
{
	.cmd = "AT+CMGL=\"ALL\"\r\n",
	.cmdSize = sizeof("AT+CMGL=\"ALL\"\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd deleteALL = 
{
	.cmd = "AT+CMGDA=\"DEL ALL\"\r\n",
	.cmdSize = sizeof("AT+CMGDA=\"DEL ALL\"\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
...
static GSM_Cmd confSETUP = 
{
	.cmd = "AT+CSMP=17,167,0,16\r\n",
	.cmdSize = sizeof("AT+CSMP=17,167,0,16\r\n")-1,
	.cmdResponseOnOk = "OK",
	.timeoutMs = 10000,
	.delayMs = 6000,
	.skip = 0,
